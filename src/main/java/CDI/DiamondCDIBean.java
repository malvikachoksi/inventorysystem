...
//                System.err.println("--------symmetrues Id get---------"+symmetry_id);
        System.err.println("--------polish Id set---------" + polishestbs);

        this.polishestbs = polishestbs;
    }
//---------getter setter of the id------------    
    String compnay_id, shape_id, colour_id, clarity_id, cut_id, polish_id, fluorescence_id, symmetry_id;

    public String getCompnay_id() {
        System.err.println("------------id compnay--------" + compnay_id);
        return compnay_id;
    }

    public void setCompnay_id(String compnay_id) {
        System.err.println("------------id compnay--------" + compnay_id);
    ...
    public void setPolish_id(String polish_id) {
        this.polish_id = polish_id;
    }

    public String getFluorescence_id() {
        return fluorescence_id;
    }

    public void setFluorescence_id(String fluorescence_id) {
        this.fluorescence_id = fluorescence_id;
    }

    public String getSymmetry_id() {
        return symmetry_id;
    }

    public void setSymmetry_id(String symmetry_id) {
...
//        compnay
    ...
    public void malvika() {
        try {
            ...
            // Invoke the RESTful service method to add the diamond
...
//        Sys
//        ejb.insert_diamonds2(d.getUserId(), compnay_id, shape_id, colour_id, clarity_id, cut_id, polish_id, fluorescence_id, symmetry_id, d.getWeigth(), d.getPrice(), d);
            diamondClientRest.diamond_add2(String.valueOf(d.getUserId()), String.valueOf(compnay_id), String.valueOf(shape_id), String.valueOf(colour_id),
                    String.valueOf(clarity_id), String.valueOf(cut_id), String.valueOf(polish_id), String.valueOf(fluorescence_id), String.valueOf(d.getSymmetryId()), String.valueOf(d.getWeigth()), String.valueOf(d.getPrice()), String.valueOf(d.getAvailability()), String.valueOf(d.getCertificate()), String.valueOf(d.getMeasurements()));
            System.out.println("Diamond added successfully.");
        } catch (Exception e) {
            e.printStackTrace();
            System.err.println("Error adding diamond: " + e.getMessage());
        }
//        System.err.println("---------CDi bean call diamond add------------");
...
//        return "Diamond_Display.xhtml";
    ...
    public String mynew() {
        System.err.println("My-----new ");
        return "Diamond_Display";
    }

    public String Delete_Diamond(String did) {
        System.err.println("Delete diamond-------------" + did);
        diamondClientRest.diamond_delete(did);
        return "Diamond_Display.xhtml";
    }
